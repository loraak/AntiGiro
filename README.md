...
El proyecto ha sido construido utilizando las siguientes librerías:

* **Core:** [React 19](https://react.dev/) & [React Router DOM](https://reactrouter.com/).
* **Machine Learning:** [TensorFlow.js](https://www.tensorflow.org/js) (`@tensorflow/tfjs`)
...
3.  **Iniciar servidor de desarrollo:**
    ...
    npm start
    ```
    La aplicación se abrirá en [http://localhost:3000](http://localhost:3000). (Se recomienda desplegar primero el backend para el funcionamiento correcto de la página)
